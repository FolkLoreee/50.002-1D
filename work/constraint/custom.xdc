...
set_property PACKAGE_PIN R13 [get_ports {button_red}]
set_property IOSTANDARD LVCMOS33 [get_ports {button_red}]
set_property PULLDOWN true [get_ports {button_red}]
set_property PACKAGE_PIN R12 [get_ports {button_blue}]
set_property IOSTANDARD LVCMOS33 [get_ports {button_blue}]
set_property PULLDOWN true [get_ports {button_blue}]
set_property PACKAGE_PIN R10 [get_ports {button_green}]
set_property IOSTANDARD LVCMOS33 [get_ports {button_green}]
set_property PULLDOWN true [get_ports {button_green}]
set_property PACKAGE_PIN E3 [get_ports {life[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {life[0]}]
set_property PACKAGE_PIN D3 [get_ports {life[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {life[1]}]
set_property PACKAGE_PIN D5 [get_ports {life[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {life[2]}]
set_property PACKAGE_PIN M6 [get_ports {seven_seg_ext[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ext[0]}]
set_property PACKAGE_PIN N6 [get_ports {seven_seg_ext[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ext[1]}]
set_property PACKAGE_PIN H5 [get_ports {seven_seg_ext[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ext[2]}]
set_property PACKAGE_PIN H4 [get_ports {seven_seg_ext[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ext[3]}]
set_property PACKAGE_PIN J3 [get_ports {seven_seg_ext[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ext[4]}]
set_property PACKAGE_PIN H3 [get_ports {seven_seg_ext[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ext[5]}]
set_property PACKAGE_PIN J5 [get_ports {seven_seg_ext[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ext[6]}]
set_property PACKAGE_PIN J4 [get_ports {seven_seg_ds[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ds[0]}]
set_property PACKAGE_PIN K3 [get_ports {seven_seg_ds[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_ds[1]}]
set_property PACKAGE_PIN K2 [get_ports {seven_seg_dp[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {seven_seg_dp[0]}]
